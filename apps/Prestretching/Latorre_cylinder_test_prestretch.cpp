...
main(int argc, char *argv[])
{
  ...
  const std::string filename = "Latorre_cylinder_test_prestretch_quadratic";
  // prestretch
  ...
  const double prestretch_threshold = prestretch_rel_tol * wall_thickness;

  // material parameters Irons2022
  const double              pressure = 14.; // [kPa]
