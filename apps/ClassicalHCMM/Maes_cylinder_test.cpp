...
main(int argc, char *argv[])
{
  ...
  const std::string filename         = "Maes_cylinder_test";
  // prestretch
  const std::string prestretched_configuration =
    "../Prestretching/Maes_cylinder/Maes_cylinder_test_prestretch.mesh";
  ...
  const double              pressure = 0.015; // [MPa]
